...
public class Servlet_TopTenALongTimeAgo extends HttpServlet{
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<HTML><HEAD><TITLE>4</TITLE></HEAD>");
		out.println("<BODY>" + "<a href=\"http://localhost:8080/main\">Main Menu</a>"
				+ "<H1><div>Top10 oldest users</div></H1><br><br>");

		List<String> fromdb = DB.topTen("desc");
